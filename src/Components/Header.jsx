...
export function Header() {
  ...
  return (
    ...
    <div className="fixed top-0 w-full z-50 flex justify-center">
      <Navbar fluid rounded className="bg-black text-white max-w-[400px] mx-auto py-3 px-4 rounded-lg shadow-lg">
        <div className="flex items-center justify-between w-full">
          ...
          <Navbar.Collapse>
            ...
            <Navbar.Link href="#" active={activeLink === 'Services'} onClick={() => handleLinkClick('Services')}>Skill</Navbar.Link>
            <Navbar.Link href="#" active={activeLink === 'Project'} onClick={() => handleLinkClick('Project')}>Project</Navbar.Link>
