...
export const Profile = () => {
    return (
        <div className="flex justify-center items-center h-screen bg-gray-900">
            <div className="w-96 px-6 py-6 text-center bg-gray-800 rounded-lg xl:px-10">
                            ...
                            <div className="flex justify-center mt-5 space-x-5">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.4V416zm-33.2-243.1c-21.2 0-38.3-17.1-38.3-38.3s17.1-38.3 38.3-38.3 38.3 17.1 38.3 38.3-17.2 38.3-38.3 38.3zM416 416h-66.4v-96.5c0-23.1-.5-53-32.3-53-32.3 0-37.3 25.3-37.3 51.2V416h-66.4V202.2h63.8v29.3h.9c8.9-16.7 30.5-34.3 62.7-34.3 67 0 79.3 44.1 79.3 101.4V416z"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
